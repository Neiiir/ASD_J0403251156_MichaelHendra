...
def hitung(n):
    ...
    print("Keluar:", n)    # fase unwinding (setelah kode diatas dieksekusi, baru kode ini yang dieksekusi, dan yang dipanggil adalah angka 1 (karena ini angka terakhir sebelum print("Selesai").))
